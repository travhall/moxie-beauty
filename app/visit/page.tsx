        ...
        <div className={container}>
          ...
          <div className="grid lg:grid-cols-[1fr_1fr] xl:grid-cols-[1fr_540px] gap-10 mb-16">
            ...
            <p className="text-lg text-(--ink-soft) leading-relaxed self-end text-pretty">
              ...
              then the work, then a few minutes to talk through aftercare.
              Here&apos;s what to expect from the moment you book.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center py-14 border-b border-(--line-soft)">
            <div>
              ...
              <p className="text-(--ink-soft) leading-relaxed">
                ...
                complimentary first-visit consultation — 30 minutes, no service
                required.
              </p>
            </div>
            <div
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center py-14 border-b border-(--line-soft)">
            <div>
              ...
              <p className="text-(--ink-soft) leading-relaxed">
                ...
                always music at low volume, and one chair — yours. We don&apos;t
                double-book.
              </p>
            </div>
            <div
