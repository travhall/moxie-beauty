      ...
      <main>
        ...
        <section className="pt-14 pb-16 border-b border-(--line-soft)">
          <div className={container}>
            <Breadcrumbs page="Our Story" href="/about" />
        ...
        <section className="py-20">
          ...
          <StudioFilmstrip
            ...
            images={[
              {
                src: "/images/moxie-about-lobby.jpg",
                alt: "The Moxie studio lobby",
                width: 600,
                height: 800,
              },
              {
                src: "/images/moxie-home-room-two.jpg",
                alt: "A Moxie treatment room",
                width: 600,
                height: 800,
              },
              {
                src: "/images/moxie-about-room-one.jpg",
