...
/* ── FAQ data ───────────────────────────────────────────────────────────── */
/* TODO: confirm all FAQ answers with Jackie before launch */
const faqItems = [
  {
    num: "01",
      ...
      <section className="py-8">
        <div className={container}>
          <a
            ...
            aria-label="Open map for Moxie Beauty Studio"
            style={{
              backgroundImage:
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
              ...
              <p className="text-(--ink-soft) leading-relaxed mb-8">
                Text is best — we read messages between appointments and reply
                in clusters during the day. Email is checked twice: first thing
        ...
        <div className={container}>
          <div className="grid lg:grid-cols-[380px_1fr] gap-16 mb-12">
            ...
            <p className="text-(--ink-soft) lg:pt-12 lg:self-end leading-relaxed">
              A short list of what comes up most. If yours isn&apos;t here, send
              a text — we&apos;d rather hear it than have you guess.
            </p>
          </div>
