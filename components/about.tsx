          ...
          >
            ...
            >
              ...
              <Image
                ...
                className="h-96 w-full max-w-xl mb-8 lg:mr-10 rounded-tl rounded-tr-[4rem] rounded-br rounded-bl-[4rem] border border-l-8 border-t-8 border-(--accent) object-cover object-top z-0"
                priority={false}
                loading="lazy"
              />
            </div>
          </div>
          <div className="flex flex-col lg:flex-row items-center gap-4 my-12">
            <svg
            ...
            <blockquote className="text-3xl font-nyght-italic bg-linear-to-r from-(--foreground) to-(--accent) bg-clip-text text-transparent max-w-[56ch] text-balance">
