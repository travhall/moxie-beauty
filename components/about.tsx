      ...
      >
        <div className="max-w-5xl w-full">
          ...
          <div className="flex flex-row">
            ...
            <blockquote className="text-3xl font-nyght-italic bg-linear-to-r from-(--foreground) to-(--accent) bg-clip-text text-transparent max-w-[56ch] text-balance p-6 pl-0 mb-12">
