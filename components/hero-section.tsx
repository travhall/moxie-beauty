    ...
    >
      <div className="content bg-(--background)/80 backdrop-blur relative p-4 lg:p-0 mt-16 lg:mt-0 w-full max-w-[70ch] rounded-tr-4xl lg:rounded-tr-[25%] lg:left-56 z-20">
        ...
        <p className="text-balance mb-10 fade-in-section delay-100">
          ...
          brow transformations, we craft personalized enhancements to highlight
          your natural beauty. Let your confidence shine with treatments
          designed for real life &mdash; and those extraordinary moments.
        </p>
        <ul
      ...
      <Image
        ...
        className="absolute top-0 right-0 w-60 md:w-1/3 2xl:w-[32vw] h-96 md:h-[48vh] lg:h-[64vh] xl:h-[80vh] 2xl:h-[88vh] rounded-bl-full rounded-tl-[15%] border-l-16 border-(--accent) object-cover z-0 fade-in-section"
