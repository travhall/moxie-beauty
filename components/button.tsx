  ...
  (
    ...
    const styles = useMemo(() => {
      ...
      const variantStyles = {
        ...
        outline:
          "border border-(--foreground) bg-transparent hover:bg-(--foreground)/15 focus-visible:ring-(--foreground)/20 disabled:border-(--foreground)/30 disabled:text-(--foreground)/50",
        ghost:
