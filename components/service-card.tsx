  ...
  return (
    <div
      className={`service-card service-card-${
        cardIndex + 1
      } rounded-lg rounded-tl rounded-tr-2xl rounded-br rounded-bl-2xl border border-(--accent)/20 p-6 transition-all hover:shadow-[-8px_8px_0_0_var(--accent)] hover:translate-x-2 hover:-translate-y-2 cursor-pointer group focus-visible:ring-2 focus-visible:ring-(--accent)/50 focus-visible:ring-offset-2`}
      role="button"
      tabIndex={0}
