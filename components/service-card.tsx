...
const ServiceCard = ({
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-pretty">{preview}</p>

      <span
        className="inline-flex self-start items-center gap-1 text-(--accent) mt-4 before:absolute before:-bottom-0.5 before:left-0 before:w-full before:h-0.5 before:bg-(--accent) before:transform before:scale-x-0 before:origin-right before:transition-transform before:duration-300 before:ease-in-out group-hover:before:scale-x-100 group-hover:before:origin-left relative"
        aria-hidden="true"
      >
